...
export default function NavLateral({ user }) {
    ...
    return (<div className="nav-lateral">
        <div className="nav-lateral-content">
            ...
            <ul>
                <Link to="/home" style={{ textDecoration: 'none' }}><li className="nav-lateral-elem">Home</li></Link>
                <Link to={`/${user.userName}`} style={{ textDecoration: 'none' }}><li className="nav-lateral-elem">Profile</li></Link>
